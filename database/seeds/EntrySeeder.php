...
class EntrySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $campaign1 = DB::table('campaigns')->whereTitle('Campaña contra el abandono de estudios')->value('id');
        $campaign2 = DB::table('campaigns')->whereTitle('Campaña a favor de los pueblos originarios')->value('id');
        ...
        Entry::create([
          ...
          'recommendedEntry1' => 'Interrupción de estudios obligatorios',
          'recommendedEntry2' => 'Niños que se vieron forzados a dejar la educación obligatoria',
          'howToUse' => 'Proponemos evitar el uso de la expresión Abandono escolar y recomendamos usar la expresión “Interrupción de estudios obligatorios”. La interrupción es una situación temporal, no definitiva que puede dar una luz distinta en el asunto. Otra expresión posible "Niños que se vieron forzados a dejar la educación obligatoria" o "Niños que no han podido continuar sus estudios". Es importante recordar que si podemos explicar o extendernos más en las causas de esta interrupción en los estudios, la información podrá ser más precisa.',
          'language_id' => $spanish,
        ...
        Entry::create([
          ...
          'recommendedEntry1' => 'Pueblos indígenas',
          'recommendedEntry2' => 'Pueblos originarios',
          'howToUse' => 'Se usa habitualmente para referirse a los pueblos indígenas de Australia.',
          'language_id' => $spanish,
